...
export default {
  mounted() {
    axios.get('/api/friend/check/' + this.profile_user_slug).then(res => {
  ...
  methods: {
    add_friend() {
      this.loading = true
      axios.get('/api/friend/add/' + this.profile_user_slug).then(res => {
        this.status = 'waiting'
    ...
    accept_friend() {
      this.loading = true
      axios.get('/api/friend/accept/' + this.profile_user_slug).then(res => {
        this.status = 'friends'
    ...
    delete_friend() {
      this.loading = true
      axios.get('/api/friend/delete/' + this.profile_user_slug).then(res => {
